...
export default function Article(props) {
  ...
  function handleSaveArticle(url, title) {
    saveArticle(url, title, props.email)
      ...
      .catch(() => {
        M.toast({ html: "Something went wrong while saving the article" });
  ...
  return (
    <div className="container">
      ...
      {/* <button onClick={(e) => handleGetUrl(e)}>get url from active tab</button> */}
        ...
        <button className="waves-effect waves-light btn" onClick={() => { handleSaveArticle(url, title) }}>Save</button>
