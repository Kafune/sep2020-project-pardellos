...
describe('user related tests', () => {
    ...
    test('add correct article object to user', async () => {
        ...
        expect(testUser.articles[0].title).toBe("D66 en VVD willen opheldering over blokkering lid euthanasiecommissie")
    })
    ...
    test('check for duplicate tags', async () => {
        let inputTags = ['bt', 'cd', 'ab', 'ba', 'ac', 'ac', 'ac', 'cd', 'ba', 'bt']
