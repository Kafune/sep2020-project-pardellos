...
describe("Laterlezer e2e tests", () => {
    ...
    // goto login and log in
    // open hamburger and go to search article
    // click button search tags
    // click a checkbox -> subtag
    // clicks clear tags
    // click a checkbox -> subtag -> subtag
    // search
    // click on read article of result
    ...
    test("User saves article", async () => {
        let url = "https://nos.nl/artikel/2364047-belgie-voerde-wel-avondklok-in-effect-moeilijk-vast-te-stellen.html"
        let title = "Belgie voert avondklok in"
        let tags = [["Nieuws", "Belgie", "Avondklok"], ["Nieuws", "Corona", "Maatregelen"], ["Overheid", "Effect", "Moeilijk"]]
