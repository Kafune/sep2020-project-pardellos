...
export default function Preferences(props) {
    ...
    useEffect(() => {
        props.handleFontState(fontSizes[currentNumber])
    ...
    return <div className="row">
        ...
        <div className={"dropdown-content bg-"+(props.backgroundColor)} id="dropdown1">
            ...
            <div className="row">
                <div className="col s12">
                    <p>Font size</p>
                    <i className="small material-icons zoom-icon" onClick={addNumber}>add</i>
                    <i className="small material-icons zoom-icon" onClick={subtractNumber}>indeterminate_check_box</i>
                </div>
            </div>
        </div>
    </div>
